...
<body>
	<table id="dg" title="网关管理" class="easyui-datagrid"
		style="width:950px;height:500px"
		 data-options="
                ...
                pagination:true,
                toolbar:'#toolbar',
                url:'/SmartHouseWeb/servlet/gate?method=getAllfromAdmin',
                view:groupview,
                groupField:'userId',
		...
		<thead>
			<tr>
				...
				<th field="userId" width="33%">网关名</th>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>创建用户:</label> <input type="checkbox" name="isCreate">
			</div>
	...
	<script type="text/javascript">
		...
		function saveUser() {
			$('#fm').form('submit', {
				url : "/SmartHouseWeb/servlet/gate?method=input",
				onSubmit : function() {
					return $(this).form('validate');
				},
				success : function(result) {
